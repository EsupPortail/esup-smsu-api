 ...
 */
public class TrackInfosToThird implements Serializable {
	...
	public boolean equals(final Object obj) {
		...
		if (!(obj instanceof TrackInfosToThird)) {
			return false;
		} else {
			TrackInfosToThird trackInfosToThird = (TrackInfosToThird) obj;
