...
public abstract class AbstractContextAwareController extends AbstractDomainAwareBean {
	...
	/**
	 * @see org.esupportail.smsuapi.web.controllers.AbstractDomainAwareBean#afterPropertiesSetInternal()
	 */
	@Override
	...
	/**
	 * @see org.esupportail.smsuapi.web.controllers.AbstractDomainAwareBean#getCurrentUser()
	 */
	@Override
