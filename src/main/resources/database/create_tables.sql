create table account (ACC_ID integer not null auto_increment, ACC_LABEL varchar(32) not null, ACC_QUOTA bigint, ACC_CONSUMED_SMS bigint not null, ACC_BROKER varchar(255), ACC_BROKER_LOGIN varchar(255), ACC_BROKER_PASSWORD varchar(255), primary key (ACC_ID)) ENGINE=InnoDB;
