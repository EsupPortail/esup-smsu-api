...
create table sms (SMS_ID integer not null auto_increment, SMS_INITIAL_ID integer, SMS_SENDER_ID integer, BROKER_SMS_ID integer, SMS_STATE varchar(32) not null, SMS_DATE datetime not null, SMS_ACK_DATE datetime, SMS_PHONE varchar(255), APP_ID integer not null, ACC_ID integer not null, primary key (SMS_ID)) ENGINE=InnoDB;
